...
All pricing was manually verified from official vendor pricing pages during development.
Prices are monthly USD equivalents unless otherwise specified.
Because AI pricing changes frequently, this dataset should be considered a point-in-time snapshot rather than a permanently authoritative source.
Last verification: 2025-05-07

## Cursor
- Hobby: $0/user/month - https://cursor.com/pricing
...
## OpenAI API
- Pay-as-you-go - https://openai.com/api/pricing
